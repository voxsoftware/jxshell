...
namespace jxshell.dotnet4
{
	...
	{
		public object executer = null;

		protected invokerparam0[] invokerparams0 = null;

		protected invokerparam1[] invokerparams1 = null;

		protected invokerparam2[] invokerparams2 = null;

		protected invokerparam3[] invokerparams3 = null;

		protected invokerparam4[] invokerparams4 = null;

		protected invokerparam5[] invokerparams5 = null;

		protected invokerparam6[] invokerparams6 = null;

		protected invokerparam7[] invokerparams7 = null;

		protected invokerparam8[] invokerparams8 = null;

		protected invokerparam9[] invokerparams9 = null;
		...
		public invokerparam0 __getParam0(int index, bool p)
		{
			...
			{
				this.invokerparams0 = new invokerparam0[this.IMethods().Length];
			}
		...
		public invokerparam1 __getParam1(int index, bool p)
		{
			...
			{
				this.invokerparams1 = new invokerparam1[this.IMethods().Length];
			}
		...
		public invokerparam2 __getParam2(int index, bool p)
		{
			...
			{
				this.invokerparams2 = new invokerparam2[this.IMethods().Length];
			}
		...
		public invokerparam3 __getParam3(int index, bool p)
		{
			...
			{
				this.invokerparams3 = new invokerparam3[this.IMethods().Length];
			}
		...
		public invokerparam4 __getParam4(int index, bool p)
		{
			...
			{
				this.invokerparams4 = new invokerparam4[this.IMethods().Length];
			}
		...
		public invokerparam5 __getParam5(int index, bool p)
		{
			...
			{
				this.invokerparams5 = new invokerparam5[this.IMethods().Length];
			}
		...
		public invokerparam6 __getParam6(int index, bool p)
		{
			...
			{
				this.invokerparams6 = new invokerparam6[this.IMethods().Length];
			}
		...
		public invokerparam7 __getParam7(int index, bool p)
		{
			...
			{
				this.invokerparams7 = new invokerparam7[this.IMethods().Length];
			}
		...
		public invokerparam8 __getParam8(int index, bool p)
		{
			...
			{
				this.invokerparams8 = new invokerparam8[this.IMethods().Length];
			}
		...
		public invokerparam9 __getParam9(int index, bool p)
		{
			...
			{
				this.invokerparams9 = new invokerparam9[this.IMethods().Length];
			}
